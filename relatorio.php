...
<main class="container">
  ...
  <form style="padding-top: 120px;" method="POST" enctype="multipart/form-data">
    <div class="input-field col s6">
          <input placeholder="Nome Do Projetos" id="first_name" type="text" class="validate" name="nome">
    </div>
      <div class="row">
        <div class="input-field col s6">
        
          <input placeholder="Data de Inicio" id="first_name" type="date" class="validate" name="dt_inicio">
        
        </div>
        <div class="row">
        <div class="input-field col s6">
          <input placeholder="Data de Entrega" id="first_name" type="date" class="validate" name="dt-final">
        </div>
      <div class="row">
    <input type="file" name="arquivo" accept="relatorios/*">
    <button class="btn waves-effect waves-light" type="submit" name="Enviar">Enviar Relatório</button>
  </form>
 <a href="editar-relatorio.php" style="color: #000000; float: right; text-decoration: none; font-weight: 900;">Editar Relatórios</a>
...
$stmt = $st->prepare("INSERT INTO projetos 
                      (nm_projetos,
                      dt_inicio_projetos, 
                      dt_final_projetos, 
                      nm_relatorio) VALUES (
