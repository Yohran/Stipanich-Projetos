...
<body>
  ...
  <article class="container sis" style="border: 1px solid #000000;">
    ...
    <div class="col s12">
      ...
      <ul>
        <li><a href="upload.php" class="menusis">Enviar Arquivos</a></li>
        <li><a href="relatorio.php" class="menusis">Cadastrar Projetos e Relatórios</a></li>
        <li><a href="ponto.php" class="menusis">Bater o Ponto (BETA!)</a></li>
      </ul>
  </div>
  </article>
</main>
