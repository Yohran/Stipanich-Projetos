...
<header class="menu">
    ...
    <div class="nav-wrapper">
      ...
      <ul id="nav-mobile" class="right hide-on-med-and-down">
        ...
        <li><a href="colaborador.php" class="top-menu">Área do Colaborador</a></li>
      </ul>
    </div>
...
<main class="container">
  <form method="POST" action="autenticacao.php" class="autenti">
    <div class="row">
     ...
     <div class="row">
        <div class="input-field col s6">
          ...
          <div class="input-field col s6">  
        <input type="submit" name="confirmar" class="sub" placeholder="">
        <a href="esqueci.php" class="sub" style="color: #000000;">Esqueci a senha / primeiro acesso</a>
      </div>
    </div>
        
  </form>
    <a href="admin.php" class="adm">Administrador</a>
</main>
