...
<main>
	<div class="row container">
		...
		<form method="POST" action="cadusuario.php">
          ...
          <input placeholder="Nome Completo" id="first_name" type="text" class="validate" name="nome">
        </div>
      <div class="row">
      ...
      <div class="row">
        <div class="input-field col">
          <input type="submit" name="enviar" value="Cadastrar" class="sub">
        </div>
      </div>
	</form>
</div>
