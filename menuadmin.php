...
<head>
  ...
  INCLUDE 'conexao.php'; 
    session_start();
    $_SESSION['nomeadmin'] = 'Cleiton Stipanich';
  ?>
  <meta charset="utf-8">
...
<main class="admin">
  <article class="container sis" style="border: 1px solid #000000;">
    <br>
    <div class="col s12">
      <h1 class="title">Bem vindo <?php echo $_SESSION['nomeadmin'];?>!</h1>
      <ul>
        <li><a href="cadastro.php" class="menusis">Cadastrar Novos Usuários</a></li>
        <li><a href="upload.php" class="menusis">Subir Arquivos</a></li>
        <li><a href="alterar.php" class="menusis">Alterar ou Deletar Usuários</a></li>
      </ul>
  </div>
  </article>
</main>
