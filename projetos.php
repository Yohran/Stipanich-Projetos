...
<main>
  <article class ="project">
    ...
    <header class="principal container">
      <h1 class="title intro">Projeto Industriais</h1>
      <p class="text-s">*Tubulação Industrial;<br>
        *Mecânica e Equipamentos;<br>
        *Estrutura Metálica;<br>
        *Elétrica/SPDA;<br>
        *Instrumentação Industrial;<br>
        *Processo e Automação;<br>
        *Planejamento e Controle;</p>
           
    </header>
    </div>
    <a href="projetos.php" id="scroll-top" class="voltar-ao-topo" "></a>
  </article>
</main>
