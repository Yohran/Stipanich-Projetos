...
<main class="container">
  <form method="POST" action="autenticacaoadmin.php" class="autenti">
    <div class="row">
        <div class="input-field col s6">
          <input id="Nome" type="email" class="validate" name="login">
     ...
     <div class="row">
        ...
        <a href="colaborador.php" class="colabo">Colaborador</a>
      </div>
    </div>
